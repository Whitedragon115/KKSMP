...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!getuser?.ign) return interaction.editReply({ content: `**請先註冊遊戲帳號在註冊經濟帳號喔**`, ephemeral: true })
        if (getuser.ban) return interaction.editReply({ content: `**你已被封鎖，無法使用此功能**`, ephemeral: true })
